       ...
       <div class="group title_b">&nbsp ${boardlists.title }</div>
		...
		<div class="tag_likes">
          ...
          <div class="group_wrapper">
            <div class="group place_b"><span>場所</span>&nbsp ${boardlists.place }</div>
            <div class="group during_b"><span>募集期間</span>&nbsp ${boardlists.startdate } ~ ${boardlists.enddate}</div>
            <div class="group date_b"><span>募集日</span>&nbsp ${boardlists.meetdate }</div>
          </div>
        </div>
