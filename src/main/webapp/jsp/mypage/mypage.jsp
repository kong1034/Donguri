    ...
    <div class="container_mp">
      <div class="mypage_top">
        ...
        <div class="my_profile">
          <img src="img/free-icon-squirrel-8720969.png" alt="" />
          <button class="my_info_update">정보수정</button>
        </div>
      </div>
      <div class="mypage_middle">
        <div class="middle bar">전체 내역</div>
        <div class="middle bar">기부 내역</div>
        <div class="middle bar">참여 내역</div>
        <div class="middle bar">모집중인 모임</div>
      </div>
      <div class="mypage_bottom">
        <div class="donation_info">
          ...
          <div class="donation_info_right">
            <div>기부 횟수 <span> 00회 </span></div>
            <div>봉사 횟수 <span> 00회 </span></div>
            <br />
