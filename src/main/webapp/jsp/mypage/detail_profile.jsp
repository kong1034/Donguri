...
<body>
	<form id="update_form" action="/Donguri/MyPageUpdateC" method="post" enctype="multipart/form-data">
		<div id="signup_info_container">
			<div id="signup_info_content">
				...
				<div id="next_btn">
					<button class="btn next" type="button" onclick="Validation()">次へ</button>
