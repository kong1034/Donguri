        ...
        <div id="footer_container">
            ...
            <div id="settings_modal" class="modal">
                <div class="modal_content">
                    ...
                    <div>
                        <label>
                            <input type="radio" id="device_settings" name="theme" value="device">
                            Device Settings
                        </label>
                        <label>
                            <input type="radio" id="light_mode" name="theme" value="light">
                            Light Mode
                        </label>
                        <label>
                            <input type="radio" id="dark_mode" name="theme" value="dark">
                            Dark Mode
                        </label>
                    </div>
                </div>
