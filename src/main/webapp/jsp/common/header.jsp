		...
		<ul class="header_categori_ul">
			...
			<c:choose>
				<c:when test="${sessionScope.user.u_profileimg != null }">
					<li class="header_categori_li login"><img src="img/server/${sessionScope.user.u_profileimg}" style="width: 2.5em; height: 2.5em; border: 1px solid black; border-radius: 50%;" onclick="location.href='MyPageC'" class="login"></li>
				</c:when>
				<c:otherwise>
					<li class="header_categori_li login"><img src="img/local/default_icon.png" style="width: 2.5em; height: 2.5em; border: 1px solid black; border-radius: 50%;" onclick="location.href='MyPageC'" class="login"></li>
				</c:otherwise>
			</c:choose>
			<li class="header_categori_li"><button onclick="location.href='LogoutC'" class="login" style="width: 4em; height: 2em;">Logout</button>
